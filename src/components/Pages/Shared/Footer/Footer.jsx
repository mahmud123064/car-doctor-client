        ...
        <div>
            ...
            <div className="grid grid-flow-col-3">
                <div className="footer footer-center p-4 bg-neutral text-neutral-content">
                    <p>Copyright © 2023 - All right reserved by Mahmud Industries Ltd</p>
                </div>
            </div>
